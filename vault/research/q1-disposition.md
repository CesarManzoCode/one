...
| 16 | Integración con SMT, fuzzing, Sail/Spike y Clang/GCC (§4) | abierta | [Estado actual](../roadmap/current-state.md) | Versiones de oráculos no fijadas: siguiente bloqueo `pre-código`. |
