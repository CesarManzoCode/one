...
| **MLIR** | Ya ofrece el meta-modelo que ONE necesita. Reimplementarlo peor es el riesgo R7. Implementar Core-O1 sobre MLIR sigue abierto ([Q1](../roadmap/open-questions.md)). | No la infraestructura, sino contratos semánticos que produzcan T1/T2 entre dominios distintos por unidad de complejidad. MLIR no afirma convergencia semántica entre dominios. |
